...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const phoneNumber = "7904321745";
    const message =
      `*LuthorCorp Service Request*\n\n` +
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium group-hover:text-brand-silver">
                      @luthorcorp_official
                    </p>
                  </div>
                </a>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-brand-offwhite border border-brand-navy/5 rounded-xl px-4 py-4 text-sm focus:outline-none focus:border-brand-emerald/50 transition-colors appearance-none"
                >
              ...
              <button
                type="submit"
                className="flex items-center justify-center gap-3 w-full bg-brand-navy text-white font-bold py-5 rounded-xl transition-all hover:bg-brand-navy/90 active:scale-[0.98] shadow-2xl shadow-brand-navy/10"
              >
                DISPATCH REQUEST
                <Send size={18} />
              </button>
