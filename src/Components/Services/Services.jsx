...
import { Globe, Zap, Bot, GraduationCap } from "lucide-react";

export default function Services() {
  return (
    <section
      id="services"
      className="py-32 bg-brand-offwhite relative overflow-hidden"
    >
      {/* Luminous Glows */}
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-xs uppercase tracking-[0.4em] text-brand-emerald font-bold mb-4">
              Core Capabilities
            </h2>
          ...
          <p className="text-brand-grey text-sm max-w-xs leading-relaxed opacity-70">
            We deliver highly specialized architecture for enterprises that
            demand 100% reliability and cutting-edge automation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-brand-silver text-sm md:text-base max-w-md leading-relaxed">
                  As a leading software agency in Cuddalore, we build
                  high-performance, modern websites and web applications. From
                  e-commerce to custom portals, our solutions are tailored to
                  your business growth.
                </p>
              </div>
              <div className="mt-12 flex flex-wrap gap-3">
                {["React.JS", "Node.JS", "TypeScript", "PostgreSQL", "AWS"].map(
                  (tech) => (
                    <span
                      key={tech}
                      className="px-3 md:px-4 py-1.5 rounded-full bg-white/5 border border-white/5 text-[9px] md:text-[10px] uppercase tracking-widest font-bold whitespace-nowrap"
                    >
                      {tech}
                    </span>
                  ),
          ...
          >
            <div className="relative z-10">
              ...
              <h4 className="text-xl font-bold text-brand-navy mb-4 tracking-tight uppercase tracking-[0.1em] group-hover:text-white transition-colors">
                n8n Automation
              </h4>
              <p className="text-brand-grey text-sm leading-relaxed group-hover:text-brand-silver transition-colors">
                Industrial-scale workflow automation that bridges your entire
                software stack into one cohesive unit.
              </p>
            </div>
          ...
          >
            <div className="relative z-10">
              ...
              <h4 className="text-xl font-bold text-brand-navy mb-4 tracking-tight group-hover:text-white transition-colors">
                AI Deployment
              </h4>
              <p className="text-brand-grey text-sm leading-relaxed group-hover:text-brand-silver transition-colors">
                Autonomous agents that handle complex logic and customer growth
                24/7.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex-1 relative z-10">
              <div className="inline-block px-3 py-1 rounded-full bg-brand-emerald/10 text-brand-emerald text-[10px] font-bold tracking-widest uppercase mb-6 group-hover:bg-brand-emerald/20 transition-colors">
                Premium Support
              </div>
              <h4 className="text-2xl md:text-3xl font-bold text-brand-navy mb-4 tracking-tight group-hover:text-white transition-colors">
                Academic Consultation
              </h4>
              <p className="text-brand-grey text-sm md:text-base leading-relaxed group-hover:text-brand-silver transition-colors">
                We provide the blueprint and execution for advanced technical
                theses and engineering projects that push the digital frontier.
              </p>
            </div>
