      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <a
              href="#hero"
              className="flex items-center gap-4 mb-6 group transition-all"
            >
              <img
                src={logo}
                alt="LuthorCorp"
                className="h-10 w-10 rounded-full border border-white/10 group-hover:border-brand-emerald/50 transition-all"
              />
          ...
          <div>
            ...
            <ul className="space-y-4 text-brand-silver text-xs leading-relaxed">
              <li className="hover:text-brand-emerald transition-colors">
                <a href="mailto:smhhaaris2020@gmail.com">
              ...
              <li className="pt-2 text-brand-silver block uppercase tracking-widest text-[9px] font-bold">
                Social Frontier
              </li>
              <li className="hover:text-brand-emerald transition-colors italic">
                <a
                  href="https://www.instagram.com/luthorcorp_official"
                  target="_blank"
                  rel="noreferrer"
                >
                  @luthorcorp_official
